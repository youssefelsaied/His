...
// selectionControls:TextSelectionControls().canPaste(delegate),
...
class _PinPaint extends CustomPainter {
    ...
    this.themeData,
          ...
          textStyle: decoration.textStyle ??
              themeData!.textTheme.headline1!
                  .copyWith(color: Color(0xff0FC1A7)),
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    return !(oldDelegate is _PinPaint && oldDelegate.text == this.text);
  }
  ...
  num _sumList<T extends num>(Iterable<T> list) {
    num sum = 0;
